              ...
              <>
                <div
                  ...
                  className={cx(
                    ...
                    'bg-[linear-gradient(to_bottom,var(--logoloop-fadeColor,var(--logoloop-fadeColorAuto,#000))_0%,rgba(0,0,0,0)_100%)]',
                  )}
                />
                <div
                  aria-hidden
                  className={cx(
                    ...
                    'h-[clamp(24px,8%,120px)]',
                    'bg-[linear-gradient(to_top,var(--logoloop-fadeColor,var(--logoloop-fadeColorAuto,#000))_0%,rgba(0,0,0,0)_100%)]',
                  )}
                />
              </>
            ) : (
              <>
                <div
                  ...
                  className={cx(
                    ...
                    'bg-[linear-gradient(to_right,var(--logoloop-fadeColor,var(--logoloop-fadeColorAuto,#000))_0%,rgba(0,0,0,0)_100%)]',
                  )}
                />
                <div
                  aria-hidden
                  className={cx(
                    ...
                    'w-[clamp(24px,8%,120px)]',
                    'bg-[linear-gradient(to_left,var(--logoloop-fadeColor,var(--logoloop-fadeColorAuto,#000))_0%,rgba(0,0,0,0)_100%)]',
                  )}
                />
              </>
            )}
